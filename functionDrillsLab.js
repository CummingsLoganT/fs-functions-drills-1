...
//CODE HERE
function theEliminator(cont , loser) {
...
let newContestants = theEliminator(contestants , 'Glimmer');
...
//CODE HERE
function upperMyCases(str) {
  console.log(str.toUpperCase());
}
// upperMyCases(sampleString);
...
let totalFrogs = chocFrogBuyer(32);
...
let totalFrogs2 = chocFrogBuyer2(32);
// console.log(totalFrogs);
...
let arrayIsAscending = twentyFirst(sampleArray);
